...
contract MessagingUpgradeableTest is Test {
    ...
    function test_Upgrade() public {
        ...
        ContractV2NonUpgradeable wrappedProxyV2 = ContractV2NonUpgradeable(
            address(proxy)
        );
    ...
    function test_Upgrade_WhenPersistedToStorageAfterUpgrade() public {
        ...
        ContractV2Upgradeable wrappedProxyV2 = ContractV2Upgradeable(
            address(proxy)
        );
    ...
    function test_Upgrade_WhenTimelock() public {
        ...
        timelock.schedule(
            ...
            abi.encodeWithSelector(
                wrappedRouterProxy.upgradeTo.selector,
                address(testContractV2)
            ),
            bytes32(0),
            SALT,
            MIN_DELAY
    ...
    function test_RevertUpgrade_WhenNonOwner() public {
        ...
        vm.expectRevert(
            bytes("MessagingAccess: only timelock can call this function")
        );
        wrappedRouterProxy.upgradeTo(address(testContractV2));
    }
}
